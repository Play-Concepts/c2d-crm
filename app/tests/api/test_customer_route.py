...
class TestCustomerRoutes:
    @pytest.mark.asyncio
    async def test_customer_basic_route_exists(
            self, app: FastAPI
    ) -> None:
        assert app.url_path_for("customer:basic") == "/api/customer/basic"

    @pytest.mark.asyncio
    async def test_customer_search_route_exists(
            self, app: FastAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_customer_claim_route_exists(
            self, app: FastAPI
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_customer_check_first_login_route_exists(
            self, app: FastAPI
    ) -> None:
        assert app.url_path_for("customer:check-first-login") == "/api/customer/check-first-login"
